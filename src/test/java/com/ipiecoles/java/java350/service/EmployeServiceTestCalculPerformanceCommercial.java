...
public class EmployeServiceTestCalculPerformanceCommercial {
	...
	private static Stream<Arguments> commercialTestingCalculPerformanceCommercialTestConditionNormales() {
		return Stream.of(Arguments.of("C00001", 9000L, 10000L, "", 1), Arguments.of("C00002", 9500L, 10000L, "", 1),
				Arguments.of("C00003", 11000L, 10000L, "", 3), Arguments.of("C00004", 13000L, 10000L, "", 6));
	}
